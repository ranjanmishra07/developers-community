        ...
        <div className="container">
          <div className="row">
            <div className="col-md-8 m-auto">
              ...
              <p className="lead text-center">Lets make some information for your profile to stand out</p>
              ...
              <form onSubmit={this.onSubmit}>
                <TextFieldGroup
                  ...
                  info="a unique handle for your profile,full name ,company name etc."
                />
                <SelectListGroup
                  placeholder="Status"
                  name="status"
                ...
                {socialInputs}
                <input type="submit" value="submit" className="btn btn-info btn-blobk mt-4"></input>
              </form>
            </div>
          </div>
        </div>
